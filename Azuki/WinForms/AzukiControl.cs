...
#		endif
        ...
        {
            this.View.ZoomOut();
            this.OnZoomOuted(EventArgs.Empty);
        }
        ...
        {
            this.View.ZoomIn();
            this.OnZoomIned(EventArgs.Empty);
        }

        /// <summary>
        /// ビューが縮小されたときに発生します。
        /// </summary>
        public event EventHandler ZoomOuted;

        /// <summary>
        /// ビューが拡大されたときに発生します。
        /// </summary>
        public event EventHandler ZoomIned;

        /// <summary>
        /// <see cref="ZoomOuted"/> イベントを発生させます。
        /// </summary>
        /// <param name="e">イベントの情報</param>
        protected virtual void OnZoomOuted(EventArgs e)
        {
            this.ZoomOuted?.Invoke(this, e);
        }
        ...
        /// </summary>
        /// <param name="e">イベントの情報</param>
        protected virtual void OnZoomIned(EventArgs e)
        {
            this.ZoomIned?.Invoke(this, e);
        }
        // kawasawa ADD END #1
